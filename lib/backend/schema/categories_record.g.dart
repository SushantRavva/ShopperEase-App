    ...
    while (iterator.moveNext()) {
      ...
      switch (key) {
        ...
        case 'name':
          ...
          break;
        case 'catRefer':
          result.catRefer = serializers.deserialize(value,
...
class _$CategoriesRecord extends CategoriesRecord {
  ...
  final String? name;
  @override
  final DocumentReference<Object?>? catRefer;
  @override
  ...
  _$CategoriesRecord._({this.image, this.name, this.catRefer, this.ffRef})
      : super._();
  ...
  int get hashCode {
    ...
    _$hash = $jc(_$hash, catRefer.hashCode);
...
class CategoriesRecordBuilder
  ...
  DocumentReference<Object?>? _catRefer;
  DocumentReference<Object?>? get catRefer => _$this._catRefer;
  set catRefer(DocumentReference<Object?>? catRefer) =>
      _$this._catRefer = catRefer;
  ...
  _$CategoriesRecord _build() {
    final _$result = _$v ??
        new _$CategoriesRecord._(
            image: image, name: name, catRefer: catRefer, ffRef: ffRef);
    replace(_$result);
    return _$result;
  }
}
